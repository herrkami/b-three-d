...
# This module is in large parts shamelessly copied from ocp_vscode/state.py (see
# https://github.com/bernhard-42/vscode-ocp-cad-viewer). It only applies minor
# changes specific to VSCode to make it a little more generic functions:
# - CONFIG_FILE changed to ~/.bthreed
