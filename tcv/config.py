...
# 
# Modifications by K. Schreiber (2024):
# - Replace imports from ocp_vscode by patched imports from b_three_d
# - Remove VS Code reference from the doc string in set_defaults
