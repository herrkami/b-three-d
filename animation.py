...
#
# This file is shamelessly copied from ocp_vscode/animation.py (see
# https://github.com/bernhard-42/vscode-ocp-cad-viewer). Note that .comms is 
# now implicitly imported from b_three_d.
