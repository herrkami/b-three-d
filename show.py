...
# the License.
#
# This file is shamelessly copied from ocp_vscode/show.py (see
...
# - .config, .comms, and .colors is imported from b_three_d
# - three_width and theme now controllable from here
# - Change a few notification and error strings
    ...
    *cad_objs, names=None, colors=None, alphas=None, progress=None, **kwargs
    ...
    for k, v in kwargs.items():
        if k in ["cad_width", "height"]:
            print(
                f"Setting {k} cannot be set, it is determined by webview.html"
            )
...
def show(
    *cad_objs,
    ...
    - Debug
        debug:                   Show debug statements (default=False)
